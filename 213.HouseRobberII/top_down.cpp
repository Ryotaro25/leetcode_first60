...
public:
  ...
  int rob(vector<int>& nums) {
    ...
    vector<int> max_money_start_from_1(num_size, UNDEFINED);
    vector<int> max_money_start_from_2(num_size, UNDEFINED);

    return max(RobMaxMoney(num_size - 1, 1, nums, max_money_start_from_1), 
               RobMaxMoney(num_size - 2, 0, nums, max_money_start_from_2));
  }
